...
// TODO: put here extern statements of the factory function prototypes for
// private implementation, which is needed for gs_componentDescriptorList
extern IFXRESULT IFXAPI_CALLTYPE 
CIFXInternalComponentName1_Factory( IFXREFIID interfaceId, void** ppInterface );

extern IFXRESULT IFXAPI_CALLTYPE 
CIFXInternalComponentName2_Factory( IFXREFIID interfaceId, void** ppInterface );
...
{
	// TODO:  Customize these example component descriptors for this DL.
	{
		&CID_IFXComponentName1,
		{CIFXComponentName1_Factory},
		1
	},
	{
		&CID_IFXComponentName2,
		{CIFXComponentName2_Factory},
		1
	},
	{
		&CID_IFXComponentName3,
		{CIFXComponentName3_Factory},
		1
	}
};
...
/**
	List of DIDs exposed by the plug-in module.
*/
static IFXDID gs_didList[] =
{
	// TODO:  Customize these example DIDs for this DL.
	DID_IFXDataElementName1,
	DID_IFXDataElementName2,
	DID_IFXDataElementName3
};
 ...
 */
IFXRESULT IFXAPI_CALLTYPE IFXPluginNameStartup()
{
 ...
 */
IFXRESULT IFXAPI_CALLTYPE IFXPluginNameShutdown()
{
	IFXRESULT result = IFX_OK;
...
/**
	...
	@param	pDidNumber			Pointer to the number of DIDs in DID list.

	@param	ppDidList			Pointer to the DID list array.
									   ...
									   IFXDID** ppDidList )
{
	...
	if( 0 != pDidNumber && 0 != ppDidList )
	{
		*pDidNumber = sizeof(gs_didList)/sizeof(IFXDID);
		*ppDidList = gs_didList;
	}
	else
		result = IFX_E_PARAMETER_NOT_INITIALIZED;
