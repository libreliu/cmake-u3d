...
-pquality or -pq <number 0 to 1000>: mesh's position quality (300 by default)

-tcquality or -tcq <number 0 to 1000>: mesh's texture coordinate quality (300 by default)

-nquality or -nq <number 0 to 1000>: mesh's normal quality (300 by default)

-dcquality or -dcq <number 0 to 1000>: mesh's diffuse color quality (300 by default)

-scquality or -scq <number 0 to 1000>: mesh's specular color quality (300 by default)

-gquality or -gq <number 0 to 1000>: default geometry quality (300 by default)
									  used if some of above quality factors are not set

-tquality or -tq <number 0 to 100>: texture quality (75 by default)
...
Note: description of different mesh's quality factors can be found in 
	  the Source/RTL/Component/Include/IFXAuthorGeomCompiler.h.
