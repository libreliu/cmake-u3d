...
IFXRESULT ResourceConverter::Convert()
{
	...
	{
		IFXTRACE_GENERIC( L"Received an unknown exception\n" );
...
IFXRESULT ResourceConverter::ConvertMotionResources()
{
	...
	if( 0 != resourceCount )
		printf("Motion Resources (%d)\t\t", resourceCount);
...
IFXRESULT ResourceConverter::ConvertTextureResources()
{
	...
	if( 0 != resourceCount )
		printf("Texture Resources (%d)\t\t", resourceCount);
...
IFXRESULT ResourceConverter::ConvertMaterialResources()
{
	...
	if( 0 != resourceCount )
		printf("Material Resources (%d)\t\t", resourceCount);
...
IFXRESULT ResourceConverter::ConvertShaderResources()
{
	...
	if( 0 != resourceCount )
		printf("Shader Resources (%d)\t\t", resourceCount);
...
IFXRESULT ResourceConverter::ConvertModelResources()
{
	...
	if( 0 != resourceCount )
		printf("Model Resources (%d)\t\t", resourceCount);
...
IFXRESULT ResourceConverter::ConvertLightResources()
{
	...
	if( 0 != resourceCount )
		printf("Light Resources (%d)\t\t", resourceCount);
...
IFXRESULT ResourceConverter::ConvertViewResources()
{
	...
	if( 0 != resourceCount )
		printf("View Resources (%d)\t\t", resourceCount);
