...
/**
	@file	IFXTextureModifierPlugin.cpp
...
extern IFXRESULT IFXAPI_CALLTYPE CIFXTextureModifier_Factory( IFXREFIID interfaceId, void** ppInterface );
extern IFXRESULT IFXAPI_CALLTYPE CIFXTextureModifierDecoder_Factory( IFXREFIID interfaceId, void** ppInterface );
extern IFXRESULT IFXAPI_CALLTYPE CIFXTextureModifierEncoder_Factory( IFXREFIID interfaceId, void** ppInterface );
...
{
	{
		&CID_IFXTextureModifier,
		{CIFXTextureModifier_Factory},
		1
	},
	{
		&CID_IFXTextureModifierDecoder,
		{CIFXTextureModifierDecoder_Factory},
		1
	},
	{
		&CID_IFXTextureModifierEncoder,
		{CIFXTextureModifierEncoder_Factory},
		1
	}
};
 ...
 */
IFXRESULT IFXAPI_CALLTYPE IFXTextureModifierPluginStartup()
{
 ...
 */
IFXRESULT IFXAPI_CALLTYPE IFXTextureModifierPluginShutdown()
{
	IFXRESULT result = IFX_OK;
