...
/**
  @file IFXNURBSPluginDllMain.cpp

      This module defines for IFXNURBSPlugin the main Windows
      DL entry point.  It should be placed in the
      Platform\IFXNURBSPlugin\Win32 folder.
*/
...
extern IFXRESULT IFXAPI_CALLTYPE IFXNURBSPluginStartup();
extern IFXRESULT IFXAPI_CALLTYPE IFXNURBSPluginShutdown();
                        ...
                        LPVOID    pReserved )
{
  IFXRESULT result  = IFX_OK;
    ...
    result = IFXNURBSPluginStartup();
    }
    else if ( reason == DLL_PROCESS_DETACH )
    {
    result = IFXNURBSPluginShutdown();
    }
