...
/**
	@file	IFXNewBaseMeshDllMain.cpp

			This module defines for IFXnewbaseMesh the main Windows 
			DL entry point.  It should be placed in the 
			Platform\IFXNewBaseMesh\Win32 folder.
*/
...
extern IFXRESULT IFXAPI_CALLTYPE IFXNewBaseMeshPluginStartup();
extern IFXRESULT IFXAPI_CALLTYPE IFXNewBaseMeshPluginShutdown();
						...
						LPVOID		pReserved )
{
	...
	if ( reason == DLL_PROCESS_ATTACH )
	{
		...
		result = IFXNewBaseMeshPluginStartup();
	}
	else if ( reason == DLL_PROCESS_DETACH )
	{
		result = IFXNewBaseMeshPluginShutdown();
	}
