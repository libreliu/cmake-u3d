...
#ifndef SampleAnimationAnimation_H
#include "SampleAnimationAnimation.h"
#endif
...
IFXRESULT SampleAnimationAnimation::Run( U3DSceneUtilities* pSGUtils )
{
	U32           uResourceID = 0;
	...
	InitAnimationModifier(pSGUtils,L"Box01");
	InitAnimationModifier(pSGUtils,L"Box01");
	/*
	//saving to file
...
IFXRESULT SampleAnimationAnimation::InitAnimationModifier(U3DSceneUtilities *pSGUtils, IFXString ModelName)
{
	U32           uResourceID = 0;
