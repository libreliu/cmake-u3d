...
#ifndef SampleCLODMod_H
#include "SampleCLODMod.h"
#endif
...
IFXRESULT SampleCLODMod::Run( U3DSceneUtilities* pSGUtils )
{
	U32           uResourceID = 0;
	...
	//	src += "Tests/UnitTesting/Modifiers/SampleCLODMod/simpleBox.u3d";
		src += "Tests/UnitTesting/Modifiers/SampleCLODMod/mp_box.u3d";
	...
	// write file
	{
		...
		src1 += "Tests/UnitTesting/Modifiers/SampleCLODMod/output.u3d";
