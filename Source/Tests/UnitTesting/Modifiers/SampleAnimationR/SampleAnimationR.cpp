...
#ifndef SampleAnimationR_H
#include "SampleAnimationR.h"
#endif
...
IFXRESULT SampleAnimationR::Run( U3DSceneUtilities* pSGUtils )
{
  U32           uResourceID = 0;
  ...
  pHeadModifier->GetModifierChain(&pModifierChain);
  InitAnimationModifier(pSGUtils,L"Box01",pModifierChain);
...
IFXRESULT SampleAnimationR::InitAnimationModifier(U3DSceneUtilities *pSGUtils, IFXString ModelName,IFXModifierChain* pModifierChain)
{
         U32           uResourceID = 0;
        /////////////////////////////////////////// create motion resource
