...
#ifndef SampleSkeleton2x_H
#include "SampleSkeleton2x.h"
#endif
...
IFXRESULT SampleSkeleton2x::Run( U3DSceneUtilities* pSGUtils )
{
	U32 uResourceID = 0;
	...
	IFXString name1("Scapula");
	IFXString name2("Humerus");
	IFXString name3("Ulna");
	IFXString name4("Radius");
	IFXString unn("<unnamed>");

	{
		...
		// try to add skeleton animation
		{
...

			{
				...
				IFXDECLARELOCAL(IFXUnknown,pObject);
				IFXDECLARELOCAL(IFXUnknown,pObject2);

				TEST(IFXSUCCESS(IFXCreateComponent( CID_IFXBoneWeightsModifier, IID_IFXUnknown, (void**)&pObject )), IFXException);
				TEST(IFXSUCCESS(IFXCreateComponent( CID_IFXBoneWeightsModifier, IID_IFXUnknown, (void**)&pObject2 )), IFXException);

				IFXDECLARELOCAL(IFXMarker,pMarker );
				IFXDECLARELOCAL(IFXMarker,pMarker2 );

				TEST(IFXSUCCESS(pObject->QueryInterface( IID_IFXMarker, (void**)&pMarker )), IFXException);
				TEST(IFXSUCCESS(pObject2->QueryInterface( IID_IFXMarker, (void**)&pMarker2 )), IFXException);
				...
				TEST(IFXSUCCESS(pObject2->QueryInterface( IID_IFXModifier, (void**)&pMod2)), IFXException);

				{
					...
					// If this is a chain object
					{
						...
						IFXDECLARELOCAL(IFXModifier,pObjectAsModifier2);
						TEST(IFXSUCCESS(pMod2->QueryInterface( IID_IFXModifier, (void**)&pObjectAsModifier2 )), IFXException);
						TEST(IFXSUCCESS(pModifierChain->AddModifier( *pObjectAsModifier2, IFXModifierChain::END_OF_MODCHAIN, FALSE )), IFXException);
				...
				IFXDECLARELOCAL( IFXBoneWeightsModifier, pBWM2 );
				TEST(IFXSUCCESS(pMod->QueryInterface( IID_IFXBoneWeightsModifier, (void**)&pBWM)), IFXException);
				TEST(IFXSUCCESS(pMod2->QueryInterface( IID_IFXBoneWeightsModifier, (void**)&pBWM2)), IFXException);

				IFXRELEASE( pMod2 );
				IFXRELEASE( pMod );

				pBWM->SetTotalBoneWeightCountForAuthorMesh( 8 ); // 8 - max vertex associated with weights (see below)
				pBWM2->SetTotalBoneWeightCountForAuthorMesh( 20 ); //
                ...
                // set bone weights and test return values
                {
                    ...
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 0, 1, &pBones[2], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 2, 1, &pBones[2], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 4, 1, &pBones[2], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 5, 1, &pBones[2], &pWeights[2] )),IFXException);

                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 1, 1, &pBones[2], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 3, 1, &pBones[2], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 6, 1, &pBones[2], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 7, 1, &pBones[2], &pWeights[2] )),IFXException);
                    //////////////////////////////////////////////////////////////////////////////////////

                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 10, 1, &pBones[3], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 12, 1, &pBones[3], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 13, 1, &pBones[3], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 19, 1, &pBones[3], &pWeights[2] )),IFXException);

                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 8, 1, &pBones[0], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 9, 1, &pBones[0], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 16, 1, &pBones[0], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 17, 1, &pBones[0], &pWeights[2] )),IFXException);

                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 11, 1, &pBones[1], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 14, 1, &pBones[1], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 15, 1, &pBones[1], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM2->SetBoneWeightsForAuthorMesh( 18, 1, &pBones[1], &pWeights[2] )),IFXException);
