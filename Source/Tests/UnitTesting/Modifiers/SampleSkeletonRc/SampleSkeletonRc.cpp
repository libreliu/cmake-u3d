...
#ifndef SampleSkeletonRc_H
#include "SampleSkeletonRc.h"
#endif
...
IFXRESULT SampleSkeletonRc::Run( U3DSceneUtilities* pSGUtils )
{
    U32  uResourceID = 0;
...

	{
		...
		// try to add skeleton animation
		{
...

			{
				...
				IFXDECLARELOCAL( IFXAuthorCLODResource, AClod );

				pSGUtils->GetACLODResourceFromName(sName,&AClod);
...

				{
					...
					// If this is a chain object
					{
						...
						TEST(IFXSUCCESS(AClod->GetModifierChain(&pModifierChain)), IFXException);
                ...
                // set bone weights and test return values
                {
                    ...
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 10, 1, &pBones[3], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 12, 1, &pBones[3], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 13, 1, &pBones[3], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 19, 1, &pBones[3], &pWeights[2] )),IFXException);

                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 8, 1, &pBones[0], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 9, 1, &pBones[0], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 16, 1, &pBones[0], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 17, 1, &pBones[0], &pWeights[2] )),IFXException);

                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 11, 1, &pBones[1], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 14, 1, &pBones[1], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 15, 1, &pBones[1], &pWeights[2] )),IFXException);
                    TEST(IFXSUCCESS(res = res | pBWM->SetBoneWeightsForAuthorMesh( 18, 1, &pBones[1], &pWeights[2] )),IFXException);
