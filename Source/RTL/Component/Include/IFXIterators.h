...
public:
  /// Constructor
  IFXIteratorT() : IFXIterator(sizeof(T)) {}
...
public:
  /// Constructor
  IFXFaceIter() : IFXIterator(sizeof(IFXU32Face))
  {
    m_pFace =0;
    Set32Bit(TRUE);
  }
  ...
  void Set32Bit(BOOL b32)
  {
    ...
    if(b32)
    {
      ...
      m_uDataSize = sizeof(IFXU32Face);
    }
    else
    {
      m_pFace = new IFXGenFaceU16;
      m_uDataSize = sizeof(IFXU16Face);
    }
  }
...
public:
  /// Constructor
  IFXLineIter() : IFXIterator(sizeof(IFXU32Line))
  {
    m_pLine =0;
    Set32Bit(TRUE);
  }
  ...
  void Set32Bit(BOOL b32)
  {
    ...
    if(b32)
    {
      ...
      m_uDataSize = sizeof(IFXU32Line);
    }
    else
    {
      m_pLine = new IFXGenLineU16;
      m_uDataSize = sizeof(IFXU16Line);
    }
  }
  ...
  {
    if(operand.m_uDataSize == sizeof(IFXU32Line))
    {
      Set32Bit(TRUE);
    }
    else
...
IFXINLINE void IFXVertexIter::SetVertexAttributes(IFXVertexAttributes vaAttribs)
{
	...
	{
		uStride += m_vaAttribs.GetTexCoordSize(i) * sizeof(F32);
	}
