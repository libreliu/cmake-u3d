...
private:
	...
	inline BOOL Pair::isZero( IV3D *v1 ); ///< check if this vector is zero one
...
public:
	...
	inline U32 getHeapPosition() { return HeapContext; };
	inline void setHeapPosition (U32 i) { HeapContext = i; };
