...
{
	CIFXBitStreamX::WriteU8X(0x00ff & Value);
	CIFXBitStreamX::WriteU8X(0x00ff & (Value >> 8));
}

// Write U32:
void CIFXBitStreamX::WriteU32X(U32 Value)
{
	CIFXBitStreamX::WriteU16X((U16) (0x0000ffff & Value));
	CIFXBitStreamX::WriteU16X((U16) (0x0000ffff & (Value >> 16)));
}

// Write U64:
void CIFXBitStreamX::WriteU64X(U64 Value)
{
	CIFXBitStreamX::WriteU32X((U32) (0x00000000ffffffff & Value));
	CIFXBitStreamX::WriteU32X((U32) (0x00000000ffffffff & (Value >> 32)));
}
...
void CIFXBitStreamX::AllocateDataBuffer(U32 uSize)
{
	...
	try
	{
		...
		if(NULL != puOldData)
		{
			...
			{
				uCopySize = sizeof(U32) * uOldDataSize;
			}

			else
			{
				uCopySize = sizeof(U32) * m_uDataSize;
			}
