...
// IFXStdio
IFXRESULT CIFXInternetReadBufferX::Open(IFXCHAR *pUrl)
{
	IFXRESULT rc = IFX_OK;
...
IFXRESULT CIFXInternetReadBufferX::GetSendTimeout(U32& rSendTimeout)
{
	...
	rc = m_session.GetOptions( IFXOSSOCKET_SEND_TIMEOUT, (char*)&buffer, &buflen );
...
IFXRESULT CIFXInternetReadBufferX::SetSendTimeout(const U32 sendTimeout)
{
	...
	const char* buffer = (const char*)&sendTimeout;
...
IFXRESULT CIFXInternetReadBufferX::GetReceiveTimeout(U32& rReceiveTimeout)
{
	...
	rc = m_session.GetOptions( IFXOSSOCKET_RECEIVE_TIMEOUT, (char*)&buffer, &buflen );
...
IFXRESULT CIFXInternetReadBufferX::SetReceiveTimeout(const U32 receiveTimeout)
{
	...
	const char* pBuffer = (const char*)&receiveTimeout;
